      ...
      <div className="max-w-[1000px] mx-auto px-6 md:px-12">
        ...
        <section className="mb-24 grid grid-cols-1 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-3 bg-neutral-900/5 border border-neutral-900/10 p-8 md:p-12 rounded-sm">
            <h3 className="text-3xl font-serif mb-6 border-b border-neutral-900/10 pb-4">The Lord's Day</h3>
            <ul className="space-y-6 text-lg text-neutral-700">
              <li className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                ...
                <span className="font-serif text-xl sm:text-2xl text-neutral-900">9:15 – 9:35 AM</span>
              </li>
              <li className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                <span>Morning Worship</span>
                <span className="font-serif text-xl sm:text-2xl text-neutral-900">10:00 – 11:30 AM</span>
              </li>
              <li className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 pt-2">
                <div className="flex flex-col">
                  <span>Evening Worship</span>
                  <span className="text-sm text-neutral-500 italic mt-1">No worship on 5th Sundays</span>
                </div>
                <span className="font-serif text-xl sm:text-2xl text-neutral-900">5:00 – 6:00 PM</span>
              </li>
            </ul>
          </div>
        ...
        <section className="space-y-16 mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-12">
            <div className="md:col-span-4">
              <h3 className="text-2xl font-serif text-neutral-900 sticky top-24">Order of Worship</h3>
            </div>
            <div className="md:col-span-8 text-neutral-700 leading-relaxed text-lg">
              <p>
                We follow a basic liturgy as a tool to help the congregation to perceive how our order 
                of worship follows God’s pattern in his Word and in the life of every believer: God speaks 
                and his people respond, and so on in a covenantal dialogue. This will include singing, 
                scripture readings, creeds, catechisms, the sacraments, and the sermon.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-12">
            <div className="md:col-span-4">
              <h3 className="text-2xl font-serif text-neutral-900 sticky top-24">Music</h3>
            </div>
            <div className="md:col-span-8 text-neutral-700 leading-relaxed text-lg">
              <p>
                We sing hymns, psalms, and modern songs with simple yet beautiful musical accompaniment 
                meant to encourage and equip congregational singing, which is the main form of 
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-12">
            <div className="md:col-span-4">
              <h3 className="text-2xl font-serif text-neutral-900 sticky top-24">Preaching</h3>
            </div>
            <div className="md:col-span-8 text-neutral-700 leading-relaxed text-lg">
              <p>
                We believe the Word of God is beating heart of the worship service, and so we join the 
                public reading of the Word with clear, expository preaching of Scripture. Our pastor 
                will generally preach straight through a book of the Bible in his sermon series.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-12">
            <div className="md:col-span-4">
              <h3 className="text-2xl font-serif text-neutral-900 sticky top-24">Sacraments</h3>
            </div>
            <div className="md:col-span-8 space-y-4 text-neutral-700 leading-relaxed text-lg">
              <p>
                We celebrate the Lord’s Supper every week at the end of the morning worship service. 
                We baptise both new believers and the children of believers, in line with God’s covenant 
                promises (Acts 2:39).
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-12">
            <div className="md:col-span-4">
              <h3 className="text-2xl font-serif text-neutral-900 sticky top-24">Worship for Children</h3>
            </div>
            <div className="md:col-span-8 space-y-4 text-neutral-700 leading-relaxed text-lg">
              <p>
                At Providence OPC we welcome and encourage our children to be in our “adult” worship 
                services instead of dismissing them to a separate children’s service. This is a deliberate 
                choice that flows out of who and what our children are according to the Word of God...
              </p>
              <p className="bg-neutral-900/5 p-6 rounded-sm border-l-4 border-neutral-900 mt-6 italic">
                This does mean that in our services you can occasionally hear the sounds that children make. 
                These sounds are our children and grandchildren in the faith, faithfully sitting under the 
        ...
        <section className="bg-[#EFEFEA] p-8 md:p-16 text-center rounded-sm">
          <h2 className="text-3xl md:text-5xl font-serif mb-6">Life Together</h2>
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto mb-10">
            The life of the church extends far beyond corporate worship on Sunday. We are called to build vital, life-long discipleship relationships throughout the body.
          </p>
          <Link 
            href="/events" 
